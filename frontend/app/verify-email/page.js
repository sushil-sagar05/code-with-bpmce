...
export default function VerifyEmailPage() {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      // Clear old OTP because a new OTP was generated
      setOtp('');
    ...
    <div className="min-h-screen flex items-center justify-center grid-bg pt-16 px-4 pb-16">
      ...
      >
        ...
        <div className="card-dark p-8">
          ...
          {/* Resend */}
          <div className="text-center mt-6 pt-5 border-t border-[#1f1f1f]">
            <p className="text-[#6a6a6a] font-dosis text-sm mb-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 text-[#FF6B00] font-dosis text-sm font-semibold hover:underline disabled:text-[#4a4a4a] disabled:no-underline disabled:cursor-not-allowed transition-colors"
            >
              <RefreshCw
                className={`w-4 h-4 ${
                  resendLoading
